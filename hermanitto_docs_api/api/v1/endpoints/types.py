...
from hermanitto_docs_api.schemas.document_type_schema import DocumentTypeCreate, DocumentTypeOut
...
async def create_document_type(type_in: DocumentTypeCreate, db: AsyncSession = Depends(get_db)):
